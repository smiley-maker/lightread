    ...
    <div className="legal-page">
      ...
      <div className="legal-container">
        ...
        <section>
          ...
          <ul>
            <li><strong>Monthly Plan:</strong> $5.00 per month, billed on the same day each month</li>
        ...
        <section>
          ...
          <p>Standard subscription payments are non-refundable. However:</p>
          <ul>
            <li>If you experience technical issues that prevent you from using the service, please contact jordan.sinclair@du.edu and we will work with you to resolve the issue</li>
            <li>In cases of billing errors or unauthorized charges, we will investigate and provide appropriate remedies</li>
            <li>Refund requests must be submitted within 7 days of the charge</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul>
            ...
            <li>Contact jordan.sinclair@du.edu to request account deletion</li>
